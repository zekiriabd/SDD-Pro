...
Use the Python-only runtime helper after resolving the selected ports:

`\\bash
python .sdd/python/sdd_scripts/server_control.py --port Backend:8080 --port Frontend:5173 --port Console:4000
`
